<%@ Page Title="Book Details" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="BookListAdmin.aspx.cs" Inherits="LibrarySystem.BookListAdmin" %>
...
<asp:Button ID="btnToggleCategoryForm" runat="server" Text="Add New Category" OnClick="btnToggleCategoryForm_Click" CssClass="btn btn-success" />

<asp:Panel ID="pnlAddCategory" runat="server" CssClass="row form-container mt-3" Visible="false">
...
<asp:FileUpload ID="fuBookImage" runat="server" CssClass="form-control mb-3" accept="image/*" />
            ...
            <div class="col-md-6 mb-3">
                ...
                <asp:DropDownList ID="ddlPublisher" runat="server" CssClass="form-select" />
            </div>
            <div class="col-md-6 mb-3">
...
<asp:GridView ID="gvBooks" runat="server" CssClass="table table-bordered"
              AutoGenerateColumns="False" OnRowCommand="gvBooks_RowCommand"
              OnRowDataBound="gvBooks_RowDataBound" DataKeyNames="Id">
    <Columns>
        ...
        <asp:BoundField DataField="CopiesForSale" HeaderText="For Sale" />
        <asp:BoundField DataField="CopiesForBorrow" HeaderText="For Borrow" />
    ...
    <ItemTemplate>
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                <!-- Confirm Link -->
                <li>
                    <asp:LinkButton ID="lnkConfirm" runat="server" CommandName="ConfirmBook" CommandArgument='<%# Eval("Id") %>' CssClass="dropdown-item">Confirm</asp:LinkButton>
                </li>
                <!-- Edit Link -->
                <li>
                    <asp:LinkButton ID="lnkEdit" runat="server" CommandName="UpdateBook" CommandArgument='<%# ((GridViewRow)Container).RowIndex %>' CssClass="dropdown-item">Edit</asp:LinkButton>
                </li>
<!-- Accept Update Link -->
                <li>
                    <asp:LinkButton ID="lnkAcceptUpdate" runat="server" CommandName="AcceptUpdate" CommandArgument='<%# Eval("Id") %>' CssClass="dropdown-item" 
                        Visible='<%# Eval("LastUpdateStatusId") != DBNull.Value && Convert.ToInt32(Eval("LastUpdateStatusId")) == 2 %>'>Accept Update</asp:LinkButton>
                </li>
                <li>
                    <asp:LinkButton ID="lnkRejectUpdate" runat="server" CommandName="RejectUpdate" CommandArgument='<%# Eval("Id") %>' CssClass="dropdown-item" 
                        Visible='<%# Eval("LastUpdateStatusId") != DBNull.Value && Convert.ToInt32(Eval("LastUpdateStatusId")) == 2 %>'>Reject Update</asp:LinkButton>
                </li>
                <!-- Reject Link -->
                <li>
                    <asp:LinkButton ID="lnkReject" runat="server" CommandName="RejectBook" CommandArgument='<%# Eval("Id") %>' CssClass="dropdown-item">Reject</asp:LinkButton>
                </li>
                <!-- Delete Link -->
                <li>
